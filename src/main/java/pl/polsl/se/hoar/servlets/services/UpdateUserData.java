...
public class UpdateUserData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{user.setName( obj.getString("name") );}catch( JSONException e ){}
            try{user.setSurname( obj.getString("surname") );}catch( JSONException e ){}
            try{user.setDescription( obj.getString("description") );}catch( JSONException e ){}
