    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.print( new JSONObject()
                    .put("name", (user.getName() != null ? user.getName() : JSONObject.NULL) )
                    .put("surname", (user.getSurname() != null ? user.getSurname() : JSONObject.NULL ) )  
                    .put("description", (user.getDescription() != null ? user.getDescription() : JSONObject.NULL )  )
