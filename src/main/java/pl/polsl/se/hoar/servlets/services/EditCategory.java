...
public class EditCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
             ...
             if(obj.isNull("id"))
                {
                    ...
                    .put("message", "id cannot be a null") );
                    return;
                }
            ...
            if( !currentUser.checkPermission(organisation_id, Worker.PERMISSION_DICTIONARY) )
                {
                out.print( new JSONObject().put("status", "error").put("message", "You don't have permissions") );
                return;
                }
            Category category = em.find( Category.class ,  obj.getLong( "id" ) );
            ...
            try{ category.setDescription( obj.getString("description"));}catch(JSONException e){}
