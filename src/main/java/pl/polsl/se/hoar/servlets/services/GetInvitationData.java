 ...
 * @author FRANC
 */
@WebServlet(name = "GetInvitationData", urlPatterns = {"/GetInvitationData"})
public class GetInvitationData extends HttpServlet {
           ...
           if(request.getAttribute("invitation")==null)
            {
                ...
                .put("message", "invalid invitation") );
                return;
            }
            
            String invitationId = (String) request.getAttribute("invitation");
            if (invitationId != null)
                invitation = em.find( Invitation.class, Long.parseLong(invitationId) );
            
            JSONObject output  = new JSONObject();
            
            if(invitation != null)
                output.put( "email", invitation.getEmail() );
            out.print( output );
        }
    }
