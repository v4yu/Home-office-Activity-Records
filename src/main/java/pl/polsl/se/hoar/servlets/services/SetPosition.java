 ...
 * @author FRANC
 */
@WebServlet(name = "SetPosition", urlPatterns = {"/SetPosition"})
public class SetPosition extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            em.refresh(currentUser);  
             if (!currentUser.checkPermission(organisation_id, Worker.PERMISSION_HR)) {
            ...
            worker.setPosition( obj.getString("position") );
