...
<body>
    <div class="wrapper">
        ...
        <div class="two-col">
            ...
            <img src="https://i.ibb.co/ZJwtZKh/post-2.png" alt="">
            <p>On behalf of GrzegorzEX, we are pleased to inform you that you have successfully registered to our system, in order to activate your account please confirm your email.
            <div class="button-holder">
                <a href="${link}" class="btn" target="_blank">Confirm</a>
            </div>
        </div>
        <div class="line"></div>
        <div class="logotxt">
